...
namespace ConversationApp.Data.Migrations
{
    ...
    [Migration("20250718101508_FinalScheduleMessageUpdate")]
    partial class FinalScheduleMessageUpdate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConversationApp.Entity.Entites.ScheduleMessageTarget", b =>
                {
                    b.Property<Guid>("ScheduleMessageId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("TargetUserId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("ScheduleMessageId", "TargetUserId");

                    b.HasIndex("TargetUserId");

                    b.ToTable("ScheduleMessageTargets");
                });
            ...
            modelBuilder.Entity("ConversationApp.Entity.Entites.ScheduleMessage", b =>
                {
                    b.HasOne("ConversationApp.Entity.Entites.User", "CreatedByUser")
            ...
            modelBuilder.Entity("ConversationApp.Entity.Entites.ScheduleMessageTarget", b =>
                {
                    b.HasOne("ConversationApp.Entity.Entites.ScheduleMessage", "ScheduleMessage")
                        .WithMany("Targets")
                        .HasForeignKey("ScheduleMessageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
